...
class CallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post calls_url, params: { call: { destino: @call.destino, minutos: @call.minutos, origem: @call.origem } }
    end
  ...
  test "should update call" do
    patch call_url(@call), params: { call: { destino: @call.destino, minutos: @call.minutos, origem: @call.origem } }
